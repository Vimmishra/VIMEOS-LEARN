...
const CourseCurriculum = () => {
    ...
    async function handleReplaceVideo(currentIndex) {
        ...
        const deleteCurrenMediaResponse = await mediaDeleteService(getCurrentVideoPublicId)

        console.log(deleteCurrenMediaResponse)

        if (deleteCurrenMediaResponse.success) {
            cpyCourseCurriculumFormData[currentIndex] = {
                ...cpyCourseCurriculumFormData[currentIndex],
                videoUrl: '',
                public_id: ''
                ...
                <div className="mt-4 space-y-4">
                    {
                        courseCurriculumFormData.map((curriculumItem, index) => (
                            <div key={`curriculum-item-${index}`} className="border p-5 rounded-md">
