...
const AddNewCoursePage = () => {
    ...
    const { courseCurriculumFormData, courseLandingFormData,
        ...
        currentEditedCourseId, setCurrentCourseEditedId } = useContext(InstructorContext);

    const { auth } = useContext(AuthContext);
    const navigate = useNavigate();
    const params = useParams();
    console.log(params, "cprams")
    ...
    useEffect(() => {
        if (params?.courseId) setCurrentCourseEditedId(params?.courseId);
    }, [params?.courseId]);
